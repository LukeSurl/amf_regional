! $Id: He5IncludeModule.f90,v 1.1 2006/01/18 20:10:37 bmy Exp $
MODULE He5IncludeModule

  !========================================================================
  ! Module He5IncludeModule contains the various parameter settings for
  ! the HDF-EOS5 library routines and F90 modules. (bmy, 1/13/06)
  !
  ! Original code from:
  !
  !    File:       hdfeos5.inc
  ...
  !  
  ! With extra parameter settings by Bob Yantosca (1/13/06)
  ! 
  ! NOTES:
  !========================================================================
  ...
  !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  !%%%                                                          %%%
  !%%%        Original HDF-EOS5 parameters begin here!          %%%
  !%%%                                                          %%%
  !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  !%%%                                                          %%%
  !%%%    Extra parameter settings begin here (bmy, 1/13/06)    %%%
  !%%%                                                          %%%
  !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  
  ! PARAMETERS FOR SUCCESS / FAILURE (bmy, 1/13/06)
  ! ===============================================
  INTEGER,  PARAMETER :: SUCCESS =  0
  INTEGER,  PARAMETER :: FAIL    = -1
  INTEGER,  PARAMETER :: FAILURE = -1

  ! VARIOUS PARAMETERS FOR F90 CODE THAT READS HDF-EOS5 DATA (bmy, 1/13/06)
  ! ========================================================================

  ! Machine-dependent settings
#include "define.h"

  ! KIND parameter for INTEGER*4 or INTEGER*8 (depending on system)
#if defined( NEED_INT_32 )
  INTEGER,  PARAMETER :: HE5_INT = KIND( 1e0 )
#elif defined( NEED_INT_64 )
  INTEGER,  PARAMETER :: HE5_INT = KIND( 1d0 )
#endif

  !-----------------------------------------------------------------------
  ! NOTE: The size of the following parameters may be changed arbitrarily.
  ! You need these to dimension Fortran arrays (bmy, 1/13/06)
  !-----------------------------------------------------------------------

  ! Max # of attributes per HDF-EOS file
  INTEGER(HE5_INT), PARAMETER :: HE5_MAX_ATRS = 50

  ! Max character string length for HDF-EOS file routines
  INTEGER(HE5_INT), PARAMETER :: HE5_MAX_CHAR = 1999

  ! Max # of dimensions per HDF-EOS5 file
  INTEGER(HE5_INT), PARAMETER :: HE5_MAX_DIMS = 50

  ! Max # of fields per HDF-EOS5 file
  INTEGER(HE5_INT), PARAMETER :: HE5_MAX_FLDS = 200

END MODULE He5IncludeModule
